...
import EnerblockSections from "@/components/preview/EnerblockSectionsPreview";
import Footer from "@/components/Footer";
import ProjectsSection from "@/components/preview/ProjectsSectionPreview";
import StatsSection from "@/components/preview/StatsSectionPreview";
import Rocks from "@/components/preview/RocksPreview";
...
// Internal sandbox clone of the live home page (src/app/page.tsx) — not
// linked from the header nav and marked noindex (see ./layout.tsx). New
// home-page updates land here first, decoupled from every component this
// page forks (Enerblock/Projects/Stats/Rocks) so they never touch the live
// site until promoted.
export default function BlueSunPreviewPage() {
  useEffect(() => {
    let destroyed = false;
